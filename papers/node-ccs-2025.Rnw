...
It is interesting to look at history and see how the two areas of high betweenness and the single are of closeness centrality emerged; they appear to connect the two ends of Venice to the  more central San Marco area, reflecting shifting military and residential needs.
